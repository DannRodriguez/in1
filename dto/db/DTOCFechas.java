...
@Entity
@Table(name = "C_FECHAS", schema = "INSA1")
public class DTOCFechas implements Serializable {

	private static final long serialVersionUID = 7257324370793247778L;
	...
	public int hashCode() {
		...
		result = prime * result + ((idFecha == null) ? 0 : idFecha.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DTOCFechas other = (DTOCFechas) obj;
		if (idComunidad == null) {
		...
		if (idFecha == null) {
			if (other.idFecha != null)
				return false;
		} else if (!idFecha.equals(other.idFecha))
			return false;
		if (idLocalidad == null) {
	...
	public String toString() {
		return "DTOCFechas [idProcesoElectoral=" + idProcesoElectoral + ", idDetalleProceso=" + idDetalleProceso
				...
				+ ", tipoJunta=" + tipoJunta + ", idFecha=" + idFecha + ", fecha=" + fecha + "]";
	}
