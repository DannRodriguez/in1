...
@Entity
@Table(name = "C_ETIQUETAS", schema = "INSA1")
public class DTOCEtiquetas implements Serializable {
	
	private static final long serialVersionUID = -2592819173103111268L;
	...
	@Id
	@NotNull
	@Column(name = "ID_ETIQUETA", nullable = false, precision = 2, scale = 0)
	private Integer idEtiqueta;
	
	@NotNull
	@Column(name = "CVE_ETIQUETA", nullable = false, length = 30)
	...
	public DTOCEtiquetas() {
		super();
	}

	public DTOCEtiquetas(String tipoJunta) {
		super();
	...
	public String getCveEtiqueta() {
		return cveEtiqueta;
	}

	public void setCveEtiqueta(String cveEtiqueta) {
		this.cveEtiqueta = cveEtiqueta;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DTOCEtiquetas other = (DTOCEtiquetas) obj;
		if (idComunidad == null) {
	...
	public String toString() {
		return "DTOCEtiquetas [idProcesoElectoral=" + idProcesoElectoral + ", idDetalleProceso=" + idDetalleProceso
				...
				+ ", tipoJunta=" + tipoJunta + ", idEtiqueta=" + idEtiqueta + ", cveEtiqueta=" + cveEtiqueta
