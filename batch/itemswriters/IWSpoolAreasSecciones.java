...
public class IWSpoolAreasSecciones implements ItemWriter<DTOAreasSecciones>, InitializingBean, DisposableBean {
	...
	public void afterPropertiesSet() throws Exception {
		...
		writer.write("ID_PROCESO_ELECTORAL|ID_DETALLE_PROCESO|ID_PARTICIPACION|ID_AREA_RESPONSABILIDAD|ID_TIPO_VOTO|SECCION|USUARIO|FECHA_HORA" 
				+ Constantes.DEFAULT_LINE_SEPARATOR);
	}
	
	@Override
	public void write(@NonNull Chunk<? extends DTOAreasSecciones> items) throws Exception {
		StringBuilder fila = new StringBuilder();
		
		for (DTOAreasSecciones e : items.getItems()) {			
